...
test_loader_5shot = paddle.io.DataLoader(testdataset_5shot, batch_sampler=testdatasetsamplerr_1shot,
                                         num_workers=num_workers, use_shared_memory=True)
model_zoo.baselinepp_test(test_loader_5shot, encoder_statedict, numepochs, n_way=n_way, n_support=5,
                                    n_query=n_query)
