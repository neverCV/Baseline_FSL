...
testdataset_1shot = Mini_Imagenet.metaDataSet('test',imagepath = 'E:\\Python_Code\\DeepLearning\\studyDL\\MeatLearning\\images')
...
fsmodel = model_zoo.baselinepp_test(test_loader_1shot, encoder_statedict, numepochs, n_way=n_way, n_support=n_support,
                                    n_query=n_query)

testdataset_5shot = Mini_Imagenet.metaDataSet('test',imagepath = 'E:\\Python_Code\\DeepLearning\\studyDL\\MeatLearning\\images')
